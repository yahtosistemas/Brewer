...
public class ClientesImpl implements ClientesQueries {
	...
	public Page<Cliente> filtrar(ClienteFilter filtro, Pageable pageable) {
		...
		//em cidade esta configurado para nao inicializar estado e cidade, por isso esta sendo inicializado apenas para o filtro
		//JoinType.LEFT_OUTER_JOIN - para buscar todos os registros, msm os que nao possuem cidade cadastrada, 
		//ou seja nao eh obrigatorio a cidade
