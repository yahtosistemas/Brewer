...
//Classe responsavel por informar o spring como achar os controllers
@Configuration
//esta dizendo que os controllers podem ser encontrados no mesmo pacote de CervejasController
@ComponentScan(basePackageClasses = {CervejasController.class, TabelasItensSession.class})
@EnableWebMvc //habilita para o projeto ser web
@EnableSpringDataWebSupport //utilizado pela paginacao
@EnableCaching
@EnableAsync
