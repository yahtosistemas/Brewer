...
public class CidadesController {
	...
	//@Cacheable(value = "cidades") - indica que sera usado memoria cache e que se chama cidades, poderia ser qualquer nome
	//key = "#codigoEstado" - utilizado para desativar o cache das cidades pelo codigo do estado	
	//@RequestParam(name = "estado", defaultValue = "-1") - recebe o codigo do estado como parametro da url, caso nao envia nada, default eh -1
	@Cacheable(value = "cidades", key = "#codigoEstado")
	@RequestMapping(consumes = MediaType.APPLICATION_JSON_VALUE)
	public @ResponseBody List<Cidade> pesquisarPorCodigoEstado(
			@RequestParam(name = "estado", defaultValue = "-1") Long codigoEstado) {
		try {
			Thread.sleep(500); //thread atrasa o processo apenas para deixar o .gif por em tempo rodando
